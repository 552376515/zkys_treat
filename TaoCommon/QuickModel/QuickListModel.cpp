...
void QuickListModel::setTableHeaders(const QStringList &tableHeaders){
    if(mTableHeaders==tableHeaders){
        return;
    }
    mTableHeaders=tableHeaders;
    emit tableHeadersChanged(tableHeaders);
}
